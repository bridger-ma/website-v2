          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 p-6 rounded-lg backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-gray-300 hidden md:block">
                Join our social media community to stay updated with the latest
                tech trends, industry insights, and exclusive content.
              </p>
              <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-xs md:max-w-md mx-auto md:mx-0">
                <SocialMediaIcons />
              </div>
            </motion.div>
          </div>
